...
<?php if (get_theme_mod( 'toggle_topbar_shadow', 'true') == true) {
        ...
        ?>
        .topbar {box-shadow: <?php echo $topbar_dropshadow_options; ?>;}
    <?php   }
    ...
    ?>
        #site-navigation {box-shadow: <?php echo $menu_dropshadow_options; ?>;}
    <?php   }
    ...
    if (get_theme_mod( 'toggle_searchbox_pointer', 'true') == true ) {  // Searchbox Pointer ?>
        ...
        .form-wrapper button:hover:before {border-color: transparent <?php echo get_theme_mod( 'menu_searchbutton_hover_color'); ?> transparent;}
    <?php
    } else { ?>
        .form-wrapper button:before, .form-wrapper button:hover:before {border-color: transparent transparent transparent;}
    <?php   }

    if ((get_theme_mod( 'display_background_image', 'false') == 'true' ) && (get_theme_mod( 'bg_image', 'false') != '')) {  ?>
        body {background-image: url("<?php echo get_theme_mod( 'bg_image'); ?>"); background-repeat: no-repeat; background-attachment: fixed; background-size:cover;}
    <?php
    }
...
<div class="navbar navbar-fixed-top topbar">
    <?php // Display Site Description ?!
        if ( get_theme_mod('display_brand_image') == true ) { ?>
            <a href="<?php echo esc_url( home_url( '/' ) ); ?>" rel="home" class="navbar-brand"><img src="<?php echo get_theme_mod('brand_image'); ?>" alt="<?php bloginfo('name'); ?> - <?php echo get_bloginfo( 'description'); ?>"></a>
        <?php } ?>
