                                        ...
                                        <div class="project-duration">
                                            <p>
                                                ...
                                                <?php if (!empty($project_startdate)) { ?>
                                                    <span><span
                                                            class="fa fa-calendar"></span> <?php echo esc_html($project_startdate); ?> <?php echo __('until ', 'understrap'); ?></span>
                                                <?php }
                                                if (!empty($project_enddate)) { ?>
                                                    &nbsp;<span><span
                                                            class="fa fa-calendar"></span> <?php echo esc_html($project_enddate); ?></span>
                                                <?php } ?>
                                            </p>
                                        </div>
                                        <?php
